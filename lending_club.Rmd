...
wordcloud(corpus_desc,min.freq = 10000,random.order = F,colors = brewer.pal(8,"Dark2"))
wordcloud(corpus_desc_nd,min.freq = 10000,random.order = F,colors = brewer.pal(8,"Dark2"))
```
...
### Feature Selection
List of feature selection variables.
...
feature_list <- c('loan_amnt','funded_amnt','funded_amnt_inv','term','int_rate','installment','grade','sub_grade','emp_length','home_ownership',
                  ...
                  'mths_since_last_delinq','open_acc','pub_rec','revol_bal','revol_util','total_acc','initial_list_status','out_prncp',
                  'out_prncp_inv','total_pymnt','total_pymnt_inv','total_rec_prncp','total_rec_int','total_rec_late_fee','recoveries',
                  'collection_recovery_fee','last_pymnt_amnt','last_fico_range_high','last_fico_range_low','collections_12_mths_ex_med',
                  ...
                  'total_il_high_credit_limit','hardship_flag','hardship_reason','disbursement_method','debt_settlement_flag',
                  'grade_ordinal','sub_grade_ordinal','verified_status_flag','source_verified_status_flag','pymnt_plan_flag',
                  'hardship_type_int_only_3mths_deferral_flag','disbursement_method_direct_pay_flag',
                  'fico_range','last_fico_range','emp_title_clean')
```
...
possible_var_df = model_df[(model_df$pvalue<0.1),]
...
```{r}
omission_list = c('last_fico_range_high','last_fico_range_low','fico_range_high','fico_range_low','out_prncp_inv',
                  'total_pymnt_inv','total_pymnt','collection_recovery_fee','last_pymnt_amnt','open_rv_24m',
                  'bc_open_to_buy','num_tl_op_past_12m','sub_grade')
...
```{r}
model.rf <- h2o.randomForest(x=names(loanbook)[(names(loanbook) %in% possible_var_2_df$variable)], y='default',
                     training_frame=h2o_train, validation_frame=h2o_validation, 
                     nfolds=5, seed=612, 
