...
feature_list <- c('loan_amnt','funded_amnt','funded_amnt_inv','term','int_rate','installment','grade','sub_grade','emp_length','home_ownership',
                  ...
                  'total_pymnt','total_pymnt_inv','last_pymnt_amnt','last_fico_range_high','last_fico_range_low','collections_12_mths_ex_med',
...
```{r}
plot(h2o.performance(model_rf,validation),type='roc')
```
